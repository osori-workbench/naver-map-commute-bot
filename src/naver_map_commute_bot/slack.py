...
class SlackWebhookClient:
    def __init__(self, webhook_url: str, session: requests.Session | Any | None = None) -> None:
    ...
    def send(self, payload: dict[str, Any]) -> None:
        ...
        print(
            f"[slack] delivered status={response.status_code} body={response.text!r} webhook={self._mask_webhook_url()} payload={payload}",
            flush=True,
        )
